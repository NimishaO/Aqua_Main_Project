                ...
                <div class="header-wrapper">
                    ...
                    <ul class="menu ml-auto">
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="addLeave.php">Apply</a>
                                </li>
                                <li>
                                    <a href="listLeaves.php">Applied</a>
                                </li>
                         ...
                         <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="listSchedule.php">View</a>
                                </li>
                                <li>
                                    <a href="editSchedule.php">My Schedule</a>
                                </li>
