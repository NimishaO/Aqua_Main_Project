...
$rules= array("fname"=>array("required"=>"","minlength"=>3,"maxlength"=>20,"alphaonly"=>""),
                ...
                "phone"=>array("required"=>""),	"address"=>array("required"=>""),
...
if(isset($_POST["reg"]))
{
  ...
  $ldata =array("email"=>$_POST["email"],"password"=>$_POST["password"],"status"=>"1","u_type"=>"user");
        ...
        $data = array("login_id"=>$lid,"fname"=>$_POST["fname"],"lname"=>$_POST["lname"],"email"=>$_POST["email"],"gender"=>$_POST["gender"],"phone"=>$_POST["phone"],"address"=>$_POST["address"],"status"=>"1");
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="sign-in-form-area">
                        ...
                        <form class="sign-in-form" method="POST" name= "reg">
                            ...
                            <div class="form-group">
                                ...
                                <p class="mt-2"><a href="sign-up.php">Already Register? Sign in</a></p>
                            </div>
                        </form>
                    </div>
                </div>
